...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-svh flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
      ...
      <Card className="w-full max-w-md relative z-10 border-slate-700 bg-slate-800/90 backdrop-blur-sm shadow-2xl">
        ...
        <CardContent className="pt-4">
          ...
          <div className="mt-4 text-center">
            <Link href="/forgot-password?type=admin" className="text-sm text-emerald-400 hover:text-emerald-300 font-medium" data-testid="link-forgot-password">
              Forgot Password?
            </Link>
          </div>
